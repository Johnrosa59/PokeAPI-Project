package com.example.pokeapirecyclerview.di;
...
import com.example.pokeapirecyclerview.data.di.NetworkModule_ProvidePokeAPIFactory;
import com.example.pokeapirecyclerview.data.di.NetworkModule_ProvidePokemonRepositoryFactory;
import com.example.pokeapirecyclerview.data.di.NetworkModule_ProvideRetrofitFactory;
...
import com.example.pokeapirecyclerview.feature.pokemonlist.MainActivity;
import com.example.pokeapirecyclerview.feature.pokemonlist.viewmodel.PokemonViewModel;
import com.example.pokeapirecyclerview.feature.pokemonlist.viewmodel.PokemonViewModel_HiltModules;
import com.example.pokeapirecyclerview.feature.pokemonlist.viewmodel.PokemonViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.pokeapirecyclerview.feature.pokemonlist.viewmodel.PokemonViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(PokemonViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, PokemonViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    Provider<PokemonViewModel> pokemonViewModelProvider;
    ...
    PokeAPI pokeAPI() {
      return NetworkModule_ProvidePokeAPIFactory.providePokeAPI(NetworkModule_ProvideRetrofitFactory.provideRetrofit());
    }

    PokemonRepository pokemonRepository() {
      return NetworkModule_ProvidePokemonRepositoryFactory.providePokemonRepository(pokeAPI());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(PokemonViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (pokemonViewModelProvider))));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.pokeapirecyclerview.feature.pokemonlist.viewmodel.PokemonViewModel
